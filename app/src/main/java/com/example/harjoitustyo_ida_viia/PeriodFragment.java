...
public class PeriodFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvDaysLeft = rootView.findViewById(R.id.tvDaysLeft);
        tvDays = rootView.findViewById(R.id.tvDay);

        EditText etPeriodL = rootView.findViewById(R.id.etPeriodL);
        etCycle = rootView.findViewById(R.id.etCycle);

        Button btnSave = rootView.findViewById(R.id.btnSave);
        btnStartEnd = rootView.findViewById(R.id.btnStartEnd);
